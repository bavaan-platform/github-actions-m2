...
selenium-standalone start --headless --no-sandbox --disable-gpu --disable-dev-shm-usage --proxy-server="direct://" --proxy-bypass-list=* --whitelisted-ips="" --disable-gpu  --window-size=1400,2100 &
